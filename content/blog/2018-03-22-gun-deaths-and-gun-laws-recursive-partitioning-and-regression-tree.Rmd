...
####Data files needed to run this code can be found in my [GitHub repo](https://github.com/JListman/FirearmDeathRate) associated with the project.Read the blog post about it [here](https://medium.com/@jblistman) and see the readme file for the infographic. 
